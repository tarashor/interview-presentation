...
\begin{frame}[fragile]{Problem: Circular Route Fuel Stations}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{fuel = [2,3,4], cost = [3,4,3]} $\rightarrow$ \textbf{Output:} \texttt{-1}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Problem: Min Candy Distribution}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{[1,2,2]} $\rightarrow$ \textbf{Output:} \texttt{4}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Problem: Line Reconstruction by Height Attributes}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{[[5,0],[4,1],[6,0]]} $\rightarrow$ \textbf{Output:} \texttt{[[5,0],[4,1],[6,0]]}
  \end{itemize}
\end{frame}
