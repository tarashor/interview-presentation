...
\begin{frame}[fragile]{Problem: Spread Zeroes in 2D Array}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{[[0,1],[1,1]]} $\rightarrow$ \textbf{Output:} \texttt{[[0,0],[0,1]]}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Problem: Rotate 2D Matrix In-Place}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{[[1,2],[3,4]]} $\rightarrow$ \textbf{Output:} \texttt{[[3,1],[4,2]]}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Problem: Postfix Expression Evaluation}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{['4','13','5','/','+']} $\rightarrow$ \textbf{Output:} \texttt{6}
  \end{itemize}
\end{frame}
