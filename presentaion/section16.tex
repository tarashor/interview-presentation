...
\begin{frame}[fragile]{Problem: Minimum Coins for Change}
  \textbf{Scenario:}
  Given `denominations` of coins and a `targetAmount`, write a function to compute the fewest number of coins needed to make up that amount.
...
\begin{frame}[fragile]{Problem: Combinations count for Change}
  \textbf{Scenario:}
  Given `denominations` of coins and a `targetAmount`, return the number of combinations that make up that amount.
...
\begin{frame}[fragile]{Problem: String Segmentation using Dictionary}
  \textbf{Scenario:}
  Given a string `text` and a `dictionary` of words, return true if the string can be segmented into a space-separated sequence of dictionary words.
