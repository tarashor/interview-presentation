...
\begin{frame}[fragile]{Problem: Distinct Ways to Climb Stairs}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{4} $\rightarrow$ \textbf{Output:} \texttt{5}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Problem: Minimum Coins for Change}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{denominations = [2,5,10], targetAmount = 15} $\rightarrow$ \textbf{Output:} \texttt{2}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Problem: Combinations count for Change}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{denominations = [2,3], targetAmount = 6} $\rightarrow$ \textbf{Output:} \texttt{2}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Problem: Longest Strictly Increasing Subsequence}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{[3, 10, 2, 1, 20]} $\rightarrow$ \textbf{Output:} \texttt{3}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Problem: String Segmentation using Dictionary}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{text = 'courseplay', dictionary = ['course','play']} $\rightarrow$ \textbf{Output:} \texttt{true}
  \end{itemize}
\end{frame}
