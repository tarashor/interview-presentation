...
\begin{frame}[fragile]{Problem: Minimum Coins for Change}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{coins = [1,2,5], amount = 11} $\rightarrow$ \textbf{Output:} \texttt{3}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Problem: Combinations count for Change}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{coins = [1,2,5], amount = 5} $\rightarrow$ \textbf{Output:} \texttt{4}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Problem: String Segmentation using Dictionary}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{s = 'leetcode', wordDict = ['leet','code']} $\rightarrow$ \textbf{Output:} \texttt{true}
  \end{itemize}
\end{frame}
