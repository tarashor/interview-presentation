...
\begin{frame}[fragile]{Problem: Cycle Detection in Linked Nodes}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{node = [1,2,3], cycle at index 0} $\rightarrow$ \textbf{Output:} \texttt{true}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Problem: Center Node of Link Sequence}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{[10, 20, 30, 40, 50]} $\rightarrow$ \textbf{Output:} \texttt{Node(30)}
    \item \textbf{Input:} \texttt{[10, 20, 30, 40, 50, 60]} $\rightarrow$ \textbf{Output:} \texttt{Node(40)}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Problem: Find Repeated Number in Constant Space}
  ...
  \textbf{Examples:}
  \begin{itemize}
    \item \textbf{Input:} \texttt{[3, 1, 3, 4, 2]} $\rightarrow$ \textbf{Output:} \texttt{3}
  \end{itemize}
\end{frame}
