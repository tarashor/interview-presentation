...
\begin{frame}[c]{\empty}
    \begin{center}
        \Large \textbf{Problem 1: \href{https://leetcode.com/problems/two-sum/}{Two Sum}}
    \end{center}
\end{frame}

% Detailed slides for Two Sum (migrated from section11)
...
\begin{frame}[c]{\empty}
    \begin{center}
        \Large \textbf{Problem 2: \href{https://leetcode.com/problems/3sum/}{3Sum}}
    \end{center}
\end{frame}

% Problem 3: Container With Most Water Link
\begin{frame}[c]{\empty}
    \begin{center}
        \Large \textbf{Problem 3: \href{https://leetcode.com/problems/container-with-most-water/}{Container With Most Water}}
    \end{center}
\end{frame}

% Detailed slides for Container With Most Water (migrated from section11)
\begin{frame}[fragile]{Container With Most Water}
    ...
    \begin{columns}[T]
        \begin{column}{0.45\textwidth}
            ...
            \begin{enumerate}
                \item $i = 0, j = n-1$.
                \item $Area = \max(h[i], h[j]) \times (j - i)$.
...
% Problem 4: Remove Duplicates from Sorted Array Link
\begin{frame}[c]{\empty}
    \begin{center}
        \Large \textbf{Problem 4: \href{https://leetcode.com/problems/remove-duplicates-from-sorted-array/}{Remove Duplicates from Sorted Array}}
    \end{center}
\end{frame}
